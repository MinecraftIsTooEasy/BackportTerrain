...
public class BWorldGenSavannaTree extends BWorldGenAbstractTree {
	public BWorldGenSavannaTree(boolean notify) {
		super(notify);
	}

	// TODO: 1.7 uses log2/leaves2 (acacia); MITE lacks them, fallback to oak wood/leaves
					...
					if (j2 != j3) {
						...
						for (l2 = k2; l2 < l && l3 > 0; --l3) {
							if (l2 >= 1) {
								...
								int id = world.getBlockId(k3, i3, l1);

								if (id == 0 || id == Block.leaves.blockID) {
									this.setBlockAndMetadata(world, k3, i3, l1, Block.wood.blockID, 0);
									i2 = i3;
								}
							}
