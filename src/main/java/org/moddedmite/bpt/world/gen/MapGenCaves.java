...
public class MapGenCaves extends MapGenBase {
	public void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int originalX, int originalZ, Block[] blocks) {
		...
		for (int j1 = 0; j1 < i1; ++j1) {
			...
			double d2 = chunkX * 16 + this.rand.nextInt(16);
			int k1 = 1;
			
			if (this.rand.nextInt(4) == 0) {
				this.func_151542_a(this.rand.nextLong(), originalX, originalZ, blocks, d0, d1, d2);
			...
			for (int l1 = 0; l1 < k1; ++l1) {
				...
				this.func_151541_a(this.rand.nextLong(), originalX, originalZ, blocks, d0, d1, d2, f2, f, f1, 0, 0, 1.0D);
			}
		}
	}
